...
class I_KYB_Ins10I extends StatefulWidget {
  @override
  I_KYB_Ins10IState createState() => I_KYB_Ins10IState();
}

class I_KYB_Ins10IState extends State<I_KYB_Ins10I> {
  Item QI_E1 = Item();
  Screen Screen_QI_E1 = Screen();
  Item QI_E1AUTRE = Item();
  Screen Screen_QI_E1AUTRE = Screen();
  ...
  void initState() {
    ...
    QI_E1 = Tools.Get_UNIQUE("Q_E1");
    QI_E1AUTRE = Tools.Get_UNIQUE("Q_E1AUTRE");
    ...
    Q_E1AUTRE = Tools.Get_UNIQUE("Q_E1AUTRE");
    void screenVoidCallback() {
      setState(() {});
    }

    Screen_QI_E1 = Tools.Get_ScreenCallBack(QI_E1, context, DbTools.gActivite_ins.contrainteRencontre!, 0, false, screenVoidCallback);
  ...
  Widget build(BuildContext context) {
    ...
    print(" DbTools.gActivite_ins.formaliteAdministrativeContraignante ${DbTools.gActivite_ins.formaliteAdministrativeContraignante}");

    Screen_QI_E1AUTRE = Tools.Get_Screen(QI_E1AUTRE, context, DbTools.gActivite_ins.autreContrainte!, 0, false);
    ...
    print(">>>>>>>>>>>>>>>>>>>   Build  ${Screen_QI_E1.Screen_Rep_Int}  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: CommonAppBar.TitleEcr("KYB${DbTools.isFORMEL?'F' : 'I'}", "INFOS CONTR", pageEntr, DbTools.pagesEntr, "B10I"),
          leading: IconButton(
...
//                  Screen_QI_E1.Screen_Row,
//                  Screen_QI_E1.Screen_Rep_Int != 20 ? Container() : Screen_QI_E1AUTRE.Screen_Row,
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              onPressed: () async {
                print("Validation OK");
                setState(() {
                  DbTools.gActivite_ins.contrainteRencontre = Screen_QI_E1.Screen_Rep_Str;
                  DbTools.gActivite_ins.autreContrainte = Screen_QI_E1AUTRE.Screen_Rep_Str;
