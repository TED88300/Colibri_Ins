package com.mafa.colibri_Collecte
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "$CHANNEL/intent_result").setMethodCallHandler { call, result ->
            when(call.method) {
                ...
                "QrCode" ->{
                    ...
                    val biteArray = call.argument<ByteArray>("bitmap")

                    val arrayInputStream = ByteArrayInputStream(biteArray as ByteArray?)
                    ...
                    try {
                        ...
                        Log.d("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ MainActivity", "Edition: printBitmap >>>>")
  ...
  //              Log.d("MainActivity", "onStatusChanged")
    ...
    //            Log.d("MainActivity", "onProviderEnabled ")
      ...
      //          Log.d("MainActivity", " onProviderDisabled")
         ...
         val MIN_TIME_BETWEEN_UPDATES = 0L //10000L // time in milliseconds (1000)
         val MIN_DISTANCE_CHANGE_FOR_UPDATES = 0f //5f  // distance is in meters (100)
